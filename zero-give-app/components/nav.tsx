export function Nav() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <div className="px-8 lg:px-14 py-5 flex items-center justify-between backdrop-blur-md bg-ink/55 border-b border-rule">
        <a href="#hero" className="flex items-center gap-3 group" aria-label="Zero Give home">
          <span className="display text-[15px] tracking-tightest leading-none">ZERO/GIVE</span>
