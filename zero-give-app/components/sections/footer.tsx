      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-14">
        ...
        <div className="mt-16 grid md:grid-cols-12 gap-12 border-t border-rule pt-12">
          ...
          <div className="md:col-span-3">
            <p className="label text-bone/75 mb-5">Newsletter</p>
        ...
        <div className="mt-16 pt-8 border-t border-rule flex flex-wrap items-center justify-between gap-6 text-bone/75 text-xs">
